    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                .exceptionHandling(exceptions -> exceptions
                        ...
                        .requestMatchers("/v1/projects/specialist/**").permitAll()
                        .requestMatchers("/v1/projects/project/**").permitAll()
                        .requestMatchers("/v1/jobs/organization/**").permitAll()
                        .requestMatchers("/v1/jobs/job/**").permitAll()
                        .requestMatchers("/v1/getByUsername/**").permitAll()
